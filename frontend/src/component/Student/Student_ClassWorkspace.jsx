...
export default function Student_ClassWorkspace() {
  ...
  // Reset members page when switching tabs
  useEffect(() => {
    if (selected !== "members") {
      setMembersPage(1);
    }
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen overflow-hidden">
      ...
      <div className="flex-1 bg-gray-100 p-4 sm:p-6 md:p-10 overflow-auto font-poppinsr md:ml-64">
        ...
        {/* Content Area */}
        <ClassContent selected={selected} membersPage={membersPage} setMembersPage={setMembersPage} membersPerPage={MEMBERS_PER_PAGE} />
      </div>
    </div>
  );
}