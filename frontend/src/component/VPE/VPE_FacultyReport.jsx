...
export default function VPE_FacultyReport() {
  ...
  const FACULTY_LOGINS_PER_PAGE = 10;

  // Pagination for student activity audit
              ...
              <div>
                ...
                {loadingReceivedReports ? (
                  ...
                  <>
                    {/* Pagination logic */}
                    {(() => {
                      const totalReportsPages = Math.ceil(receivedReports.length / REPORTS_PER_PAGE);
                      const startReportsIndex = (reportsPage - 1) * REPORTS_PER_PAGE;
                      const endReportsIndex = startReportsIndex + REPORTS_PER_PAGE;
                      const paginatedReports = receivedReports.slice(startReportsIndex, endReportsIndex);
                  ...
                  {totalReportsPages > 1 && (
                    <div className="flex items-center justify-center mt-4 space-x-4">
                      ...
                      <span className="text-sm text-gray-700">Page {reportsPage} of {totalReportsPages}</span>
                      <button
