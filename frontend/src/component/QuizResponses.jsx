  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white rounded-xl shadow mt-8">
      ...
      <div className="flex gap-4 mb-6">
        <button className={`px-4 py-2 rounded-t ${tab==='summary' ? 'bg-blue-100 font-bold' : 'bg-gray-100'}`} onClick={()=>setTab('summary')}>Summary</button>
        <button className={`px-4 py-2 rounded-t ${tab==='individual' ? 'bg-blue-100 font-bold' : 'bg-gray-100'}`} onClick={()=>setTab('individual')}>Individual</button>
      </div>
      {tab === 'summary' && (
        <div>
