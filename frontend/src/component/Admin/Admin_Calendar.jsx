...
export default function Admin_Calendar() {
  ...
  const handleAddEvent = async (e) => {
    ...
    try {
      await axios.post("http://https://juanlms-webapp-server.onrender.com/events", {
  ...
  const handleEditEvent = async (e) => {
    ...
    try {
      await axios.put(`http://https://juanlms-webapp-server.onrender.com/events/${_id}`, {
        title,
        start,
  ...
  const handleDeleteEvent = async () => {
    ...
    if (!_id) return;
    try {
      await axios.delete(`http://https://juanlms-webapp-server.onrender.com/events/${_id}`);
      await fetchEvents();
      setShowEditModal(false);
    } catch {
