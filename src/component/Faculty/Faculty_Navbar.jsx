...
const Faculty_Navbar = () => {
    ...
    const navItems = [
        ...
        { handler: () => navigate("/faculty_classes"), icon: classesIcon, label: "Classes" },
        { handler: () => navigate("/faculty_activities"), icon: activitiesIcon, label: "Activities" },
        { handler: () => navigate("/faculty_chats"), icon: chatsIcon, label: "Chats" },
        ...
        { handler: () => navigate("/faculty_calendar"), icon: calendarIcon, label: "Calendar" },
    ];
